...
[![Maven Central](https://img.shields.io/maven-central/v/com.openai/openai-java)](https://central.sonatype.com/artifact/com.openai/openai-java/3.1.3)
[![javadoc](https://javadoc.io/badge2/com.openai/openai-java/3.1.3/javadoc.svg)](https://javadoc.io/doc/com.openai/openai-java/3.1.3)
...
The REST API documentation can be found on [platform.openai.com](https://platform.openai.com/docs). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.openai/openai-java/3.1.3).
...
```kotlin
implementation("com.openai:openai-java:3.1.3")
```
...
```kotlin
implementation("com.openai:openai-java-spring-boot-starter:3.1.3")
```
